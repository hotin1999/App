...
if ($conn-> connect_errno){
    ...
    $getSoup = "SELECT * from soupdetail ";
    $trp = mysqli_query($conn, $getSoup);
    $soup = array();
    while($x = mysqli_fetch_assoc($trp)) {
        $soup[] = $x;
        
    }
    print json_encode($soup);
    

    //==========Add Soup====================================================
    if (isset($_POST['newFoodName'])) {
    $sql = "INSERT INTO soupdetail (foodname, fooddescpirtion,pdate,edate,foodquantity,price,seller)
    ...
    if (isset($_POST['foodID'])) {
        $sql = "DELETE from soupdetail where id =".$_POST['foodID'];
